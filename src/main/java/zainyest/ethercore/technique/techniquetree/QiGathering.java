...
public class QiGathering extends PassiveTechnique {
    ...
    public QiGathering() {
        super("qi_gathering", new Identifier[0], new Identifier[]{Identifier.of(EtherCore.MOD_ID, "mental_acuity"), Identifier.of(EtherCore.MOD_ID, "body_fortification")}, "Passive", "The first step", Identifier.of(EtherCore.MOD_ID, "icon.png"));
    }
