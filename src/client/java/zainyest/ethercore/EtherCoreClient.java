...
import zainyest.ethercore.gui.screen.ingame.MeridianScreen;
...
public class EtherCoreClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
        ...
        HandledScreens.register(MeridianScreenHandler.MERIDIAN_SCREEN_HANDLER_TYPE, MeridianScreen::new);
	}
}
