...
public class EtherCoreClient implements ClientModInitializer {
    ...
    private void initRegistries() {
        ...
        HudElementRegistry.attachElementBefore(VanillaHudElements.HEALTH_BAR, Identifier.fromNamespaceAndPath(EtherCore.MOD_ID, "before_health"), EtherHudOverlay::render);
