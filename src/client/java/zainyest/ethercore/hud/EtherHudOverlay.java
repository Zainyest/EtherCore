...
public class EtherHudOverlay {
    ...
    public static void render(DrawContext context, RenderTickCounter tickCounter) {
        ...
        context.drawTextWithShadow(client.textRenderer, Text.literal(EtherData.MENTAL_ENERGY.getVal(EtherCoreClient.clientPlayerData.persistentData) + "/" + EtherData.MENTAL_ENERGY.getMax(EtherCoreClient.clientPlayerData.persistentData)).fillStyle(Style.EMPTY.withColor(Formatting.BLUE)), 188, 14, 0xff7fff7f);
